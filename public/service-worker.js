...
var whitelistedOrigins = ["http://localhost:8000"];
var whitelistedPathRegex = /\/api\/[^.]*$/; // Service worker global variables

var token = '';
var clientId = '';
var clientSecret = ''; // let hkToken = ''
...
var requestHKToken = /*#__PURE__*/function () {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch('http://localhost:8000/api/admin-3rd-party/login', {
              method: 'POST',
              headers: {
  ...
  return function requestHKToken() {
...
var addAuthHeader = function addAuthHeader(event) {
  var destURL = new URL(event.request.url);
  ...
  if (whitelistedOrigins.includes(destURL.origin) && whitelistedPathRegex.test(destURL.pathname)) {
    ...
    var authReq = new Request(event.request, {
...
var cleanedUpResponse = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(authReq) {
    var response, changeResponse, data, body, headersToReturn;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            data = _context2.sent;
            body = _extends({}, data);
            headersToReturn = new Headers(response.headers);
            headersToReturn.append('done-by', 'elijahbus'); // Retrieve token and send the response without it

            return _context2.abrupt("return", new Response(JSON.stringify(body), {
  ...
  return function cleanedUpResponse(_x) {
